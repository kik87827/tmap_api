		...
		createDateTimePicker = function (input) {
			var datetimepicker = $('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
				...
				month_picker = $('<div class="xdsoft_monthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button>' +
					'<div class="xdsoft_label_group"><div class="xdsoft_label xdsoft_month"><span></span><i></i></div>' +
			...
			month_picker
				...
				.on('touchend mousedown.xdsoft', '.xdsoft_option', function () {
					if (!this.touchMoved) {
						...
						$(this).parents(".xdsoft_month").removeClass("active");
			...
			if(options.timepicker){
				...
				datetimepicker.addClass("not_timepicker");
			}
			datetimepicker.on("click",function(e){
				if($(e.target).parents(".xdsoft_label,.xdsoft_label_group").length || !$(e.target).is(".xdsoft_label")){
					$(".xdsoft_label").removeClass("active");
				}
			});
			...
			datetimepicker
				.on('open.xdsoft', function (event) {
					...
					if (onShow !== false) {
						datetimepicker.show().addClass("active");
						setPos();
				...
				.on('close.xdsoft', function (event) {
					...
					if (onClose !== false && !options.opened && !options.inline) {
						datetimepicker.hide().removeClass("active");
					}
					event.stopPropagation();
				})
